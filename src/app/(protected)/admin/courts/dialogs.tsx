...
interface AdminCourtsDialogsProps {
...
export function AdminCourtsDialogs(props: AdminCourtsDialogsProps) {
  const {
    isFilterOpen,
    setIsFilterOpen,
    draftFilterVenueId,
          ...
          {detailCourtQuery.isLoading ? (
            ...
            <div className="space-y-4">
              {detailCourtQuery.data.imageUrl ? (
                <img
                  src={detailCourtQuery.data.imageUrl}
                  alt={detailCourtQuery.data.name}
